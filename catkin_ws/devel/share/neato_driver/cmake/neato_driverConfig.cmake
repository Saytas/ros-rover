...
if("TRUE" STREQUAL "TRUE")
  set(neato_driver_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/intro_to_ros/bv80bot/neato_robot/neato_driver)
  set(neato_driver_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(neato_driver_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/neato_driver " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/neato_driver' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Michael Ferguson <ferguson@cs.albany.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/intro_to_ros/bv80bot/neato_robot/neato_driver/${idir}'.  ${_report}")
    endif()
